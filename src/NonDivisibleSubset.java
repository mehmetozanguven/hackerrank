...
public class NonDivisibleSubset {
    ...
    static int nonDivisibleSubset(int k, int[] S) {
        ...
        // then, choose max element from the pair which together can able to be divided by k.
        ...
        //      2. If there are 2 elements in remainderArr[k], we have to choose only 1, otherwise, we can sum up 2 or more
        ...
        // will also be remainderArr[2]. Thus, we have to choose only 1 element from that pair (or we should increment
